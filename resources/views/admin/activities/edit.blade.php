...
@section('header')
    <h2 class="text-xl font-semibold text-gray-800">Edit: {{ $activity->title }}</h2>
@endsection
...
<div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
    <form action="{{ route('admin.activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-6 flex items-center gap-3">
            <button type="submit" class="bg-blue-600 px-6 py-2 text-white hover:bg-blue-700">Perbarui Aktivitas</button>
